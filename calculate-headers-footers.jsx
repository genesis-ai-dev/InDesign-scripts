...
//     // Helper to parse chapter:verse
//     function parseChapterVerse(text) {
//         var parts = text.split(':');
//         return {
//             chapter: parts.length > 1 ? parts[0] : '1',
//             verse: parts.length > 1 ? parts[1] : parts[0]
//         };
//     }
...
//                 // Extract chapter and verse from the contents
//                 var verseContents = ch.contents;
//                 var chapterVerse = parseChapterVerse(verseContents);
...
//             var headerText = '';
//             if (p % 2 === 0) { // left page
//                 headerText = (info.bookName || '') + ' ' + 
//                              (info.firstVerse ? info.firstVerse : '');
//             } else { // right page
//                 headerText = (info.bookName || '') + ' ' + 
//                              (info.lastVerse ? info.lastVerse : '');
//             }
